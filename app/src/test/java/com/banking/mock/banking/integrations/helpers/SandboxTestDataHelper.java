...
public class SandboxTestDataHelper {
    ...
    public static SandboxPaymentRequest createPaymentRequest(String debtorIban, String creditorIban, BigDecimal amount) {
        return SandboxPaymentRequest.builder()
                ...
                .creditorAccount(SandboxPaymentRequest.ParticipantAccount.builder()
                        .iban(creditorIban)
                        .currency(Currency.getInstance(PAYMENT_CURRENCY))
                        .build())
                .debtorAccount(SandboxPaymentRequest.ParticipantAccount.builder()
                        .iban(debtorIban)
                        .currency(Currency.getInstance(PAYMENT_CURRENCY))
                        .build())
    ...
    private static SandboxBalanceAmount buildBalanceAmount(AccountBalanceEntity accountBalanceEntity) {
        return SandboxBalanceAmount.builder()
                .amount(accountBalanceEntity.getAmount())
                .currency(accountBalanceEntity.getCurrency())
                .build();
    }
