 ...
 * Verifies public and private endpoint access with and without tokens.
 */
...
class ResourceServerSecurityConfigIT {
    ...
    /**
     * Ensures private endpoints require authentication.
     */
    @SneakyThrows
    ...
    /**
     * Verifies access to private endpoints with a valid token.
     */
    @SneakyThrows
    ...
    /**
     * Verifies access is denied with an invalid token.
     */
    @SneakyThrows
