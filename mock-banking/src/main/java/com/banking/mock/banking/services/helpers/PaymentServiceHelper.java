...
import com.banking.mock.banking.api.model.payment.SandboxTransactionFees;
...
public class PaymentServiceHelper {
    ...
    public static SandboxTransactionFees buildTransactionFees(BigDecimal amount, BigDecimal commissionRate) {
        return SandboxTransactionFees.builder()
